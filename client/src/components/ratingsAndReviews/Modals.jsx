...
class Modals extends Component {
  ...
  handleSubmit(event) {
    let reviewData = {
      ...
      characteristics: {
        53856: Number(this.state.Size),
        53857: Number(this.state.Width),
        53858: Number(this.state.Comfort),
        53859: Number(this.state.Quality),
      },
    };
    axios
